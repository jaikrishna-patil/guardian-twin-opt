...
if __name__ == "__main__":
    ...
    mission1 = MissionOptionsAssets(patient_name='Adrian Monk', location= [48.8584, 2.2945], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 20)
    mission2 = MissionOptionsAssets(patient_name='Natalie Tieger', location = [47.9931, 8.2454], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165'], triage_score = 10)
    mission3 = MissionOptionsAssets(patient_name='Leland Stottlemeyer', location = [46.4868, 2.4128], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165'], triage_score = 20)
    mission4 = MissionOptionsAssets(patient_name='Jake Peralta', location = [49.8675, 0.6713], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 30)
    mission5 = MissionOptionsAssets(patient_name='Sharona Fleming', location = [50.0087, 5.4571], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Chinook CH99', 'Truck M1165'], triage_score = 40)
    ...
    mission6 = MissionOptionsAssets(patient_name='Randy Disher', location = [44.5857, 3.8395], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47'], triage_score = 43)
    mission7 = MissionOptionsAssets(patient_name='Trudy Monk', location = [48.8584, 2.2945], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Chinook CH47', 'Chinook CH99'], triage_score = 13)
    mission8 = MissionOptionsAssets(patient_name='Charles Kroger', location = [48.8584, 2.2945], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 95)
    mission9 = MissionOptionsAssets(patient_name='Julie Trieger', location = [48.8584, 2.2945], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 84)
    mission10 = MissionOptionsAssets(patient_name='Benjy Fleming', location = [48.8584, 2.2945], care_facilities_possible=['Battlefield Medical Center', 'Noble Medical Center',
                                                           'Young hearts Medical Center'], assets_possible=['Black hawk HH60M', 'Chinook CH47', 'Chinook CH99', 'Truck M1165', 'Ambulance M997A3'], triage_score = 82)

    # Assets
    asset1 = Asset(asset_name='Black hawk HH60M', asset_range_in_km=1670, asset_speed_kmph=100, location=[48.5325, 0.1321])
    ...
    algo_mission_assets = MissionoptionsAssetsToMissionfinalAssetsFactory.create_missionoptionsAssets_to_missionfinalAssets_algo(mode=MissionoptionsAssetsToMissionfinalAssetsAlgoName.SCHEDULER)
    assets_all_missions = algo_mission_assets.return_mission_final_asset_scheduler(missions_options=all_mission_options, assets=all_assets, care_facilities=all_care_facilities)
