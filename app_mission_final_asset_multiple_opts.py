...
if __name__ == "__main__":
    ...
    constraint1 = Constraint(name='max allowed resources', value=3)
    constraint2 = Constraint(name='mandatory rescue based on triage score', value=50)
    ...
    algo_mission_assets = MissionoptionsAssetsToMissionfinalAssetsFactory.create_missionoptionsAssets_to_missionfinalAssets_algo(mode=MissionoptionsAssetsToMissionfinalAssetsAlgoName.OPT)
    assets_all_missions = algo_mission_assets.return_mission_final_asset_opt(missions_options=all_mission_options, constraints=all_constraints)
